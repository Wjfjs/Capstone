...
async function GetGraphDataHour() {
    try {
        const response = await fetch('http://localhost:3000/hourData', {
            method: 'POST',
            headers: {
...
async function GetGraphDataDay() {
    try {
        const response = await fetch('http://localhost:3000/dayData', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json'
            }
...
async function GetGraphDataWeek() {
    try {
        const response = await fetch('http://localhost:3000/weekData', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json'
            }
...
async function GetGraphDataMonth() {
    try {
        const response = await fetch('http://localhost:3000/monthData', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json'
            }
